export default {
	async fetch(request, env, ctx) {
		const tools = [
			...
			{ name: 'video-titles', desc: 'Chat with an AI agent to ideate YouTube titles using the Compelling Title Matrix framework; right-click any video in Explorer (requires OpenRouter API key)', icon: 'https://cdn.jsdelivr.net/gh/mikecann/mikerosoft@main/tools/video-titles/icons/video-titles.png', screenshots: [], url: 'https://github.com/mikecann/mikerosoft/tree/main/tools/video-titles' },
		];
